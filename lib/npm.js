...
// https://www.jianshu.com/p/1da6271617c5
...
class Npm extends EventEmitter {
  ...
  constructor () {
    ...
    this.config = new Config({
      npmPath: dirname(__dirname), // /Users/yuanzhian/code/zcy/new-openSources/cli
      definitions, // 定义的命令行
      flatten, // 扁平化
      shorthands,
      log,
  ...
  async [_load] () {
    ...
    let node
    try {
      // 在 PATH 环境变量中查找指定可执行文件的第一个实例，不缓存结果
